...
builder.add_conditional_edges(source="check_x", path=is_even, path_map={
    True: "handle_even",
    False: "handle_odd"
})
...
+-------------+           +------------+  
             ***          **              
               ...
               +---------+                
None
2026-04-13 16:10:46.267 | INFO     | __main__:<module>:102 - 输入 x=4（偶数）
2026-04-13 16:10:46.268 | INFO     | __main__:check_x:36 - [check_x] Received state: x=4 result=None
2026-04-13 16:10:46.269 | INFO     | __main__:handle_even:59 - [handle_even] x 是偶数
