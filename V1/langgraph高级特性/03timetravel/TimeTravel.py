...
历史状态: 注意是栈结构,要从下往上看
  0. 下一步节点: ()
     检查点ID: 1f139697-7cc6-6052-8004-d5dc6ebbf148
  ...
  1. 下一步节点: ('write_ending',)
     检查点ID: 1f139697-7cc4-6fb1-8003-52f493d0cef6
     状态值: {'character': '一只会说话的猫', 'setting': '在一个神秘的图书馆里', 'plot': '一只会说话的猫在在一个神秘的图书馆里发现了一本会发光的书'}

  2. 下一步节点: ('develop_plot',)
     检查点ID: 1f139697-7cc4-6004-8002-424f63857f19
     状态值: {'character': '一只会说话的猫', 'setting': '在一个神秘的图书馆里'}

  3. 下一步节点: ('set_setting',)
     检查点ID: 1f139697-7cc2-6de0-8001-9a2f6e3b61c1
     状态值: {'character': '一只会说话的猫'}

  4. 下一步节点: ('create_character',)
     检查点ID: 1f139697-7cc1-64d2-8000-c1fee9fa42f3

  5. 下一步节点: ('__start__',)
     检查点ID: 1f139697-7cbf-6cc7-bfff-64b6e702e2bd

3. 从中间状态恢复执行，创建第二个故事...
选中的状态: ('develop_plot',)
选中的状态值: {'character': '一只会说话的猫', 'setting': '在一个神秘的图书馆里'}
新配置: {'configurable': {'thread_id': '7030b371-0ede-4bf9-86ac-495a3fcb5778', 'checkpoint_ns': '', 'checkpoint_id': '1f139697-7cc8-63fb-8003-b7d900e66b2e'}}
