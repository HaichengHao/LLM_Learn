...
# 2. Tools important（必须有 docstring）
def book_flight(from_airport: str, to_airport: str) -> str:
    """预订航班工具。根据出发机场和到达机场预订一张机票，并返回预订结果。""" #这就是docstring
...
supervisor = create_supervisor(
    agents=[flight_assistant, hotel_assistant], #tips:要求传入智能体列表
    model=init_llm_model(), #tips:传入大模型
    prompt=(
