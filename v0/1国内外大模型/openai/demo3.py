...
if __name__ == '__main__':
    ...
    search_term = input("请输入你要搜寻的相关评价(由于是Amazon平台,暂时请搜索英文评价):")
    search_text(df,search_term,top_n=3)
...
#tips:下面这个就很微妙了,譬如我输入的是电脑(computer)然后第一条可能是和EXPENSIVEL2距离近(毕竟说起电脑可能会想到它贵),第二条是和macine有近似,第三条居然是cookie！！！！因为web中的cookie是用于存储用户信息的,这里也和computer产生了关联!!!
'''
/home/nikofox/.local/bin/uv run /home/nikofox/LLMlearn/.venv/bin/python /home/nikofox/LLMlearn/V0/openai/demo3.py 
请输入你要搜寻的相关评价(由于是Amazon平台,暂时请搜索英文评价):computer
awesome; Text: I WILL BUY IT IF U LOWER UR PRICE TO EXPENSIVE !!!!!! PLEASE LOWER ITS A  GREAT PRODUCT BUT TO EXPENSIVE
------------------------------
perfection~~!!; Text: LOVE this machine.  SO easy and quick and requires little TLC and maintenance.  Been using espresso makers for over 25 years and this is best of ALL!!
------------------------------
not what i expected; Text: when i ordered this i expected a big box full of fortune cookies like the one in the pcture, nonetheless, when i got it it was very small and the fortune cookies tasted weird. they were okay, but not he best i had ever had.
------------------------------
